...
.macro SAVE_REGS
	...
	stp q0, q1,   [x21, #16*19+32*0]
	stp q2, q3,   [x21, #16*19+32*1]
	stp q4, q5,   [x21, #16*19+32*2]
	stp q6, q7,   [x21, #16*19+32*3]
	stp q8, q9,   [x21, #16*19+32*4]
	stp q10, q11, [x21, #16*19+32*5]
	stp q12, q13, [x21, #16*19+32*6]
	stp q14, q15, [x21, #16*19+32*7]
	stp q16, q17, [x21, #16*19+32*8]
	stp q18, q19, [x21, #16*19+32*9]
	stp q20, q21, [x21, #16*19+32*10]
	stp q22, q23, [x21, #16*19+32*11]
	stp q24, q25, [x21, #16*19+32*12]
	stp q26, q27, [x21, #16*19+32*13]
	stp q28, q29, [x21, #16*19+32*14]
	stp q30, q31, [x21, #16*19+32*15]
	mov x1, sp
...
restore_regs:
	...
	ldp x30, x1,  [x0, #8+16*15]
	ldp q0, q1,   [x0, #16*19+32*0]
	ldp q2, q3,   [x0, #16*19+32*1]
	ldp q4, q5,   [x0, #16*19+32*2]
	ldp q6, q7,   [x0, #16*19+32*3]
	ldp q8, q9,   [x0, #16*19+32*4]
	ldp q10, q11, [x0, #16*19+32*5]
	ldp q12, q13, [x0, #16*19+32*6]
	ldp q14, q15, [x0, #16*19+32*7]
	ldp q16, q17, [x0, #16*19+32*8]
	ldp q18, q19, [x0, #16*19+32*9]
	ldp q20, q21, [x0, #16*19+32*10]
	ldp q22, q23, [x0, #16*19+32*11]
	ldp q24, q25, [x0, #16*19+32*12]
	ldp q26, q27, [x0, #16*19+32*13]
	ldp q28, q29, [x0, #16*19+32*14]
	ldp q30, q31, [x0, #16*19+32*15]
	mov sp, x1
	ldp x0, x1,   [x0, #8+16*0]
	ret
