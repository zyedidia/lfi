...
version (arm64) {
    extern (C) bool lfiv_verify_arm64(void*, usize);
} else version (amd64) {
    extern (C) bool lfiv_verify_amd64(void*, usize);
}
...
extern (C) int main(int argc, const(char)** argv) {
    ...
    version (arm64) {
        options.verifier = &lfiv_verify_arm64;
    } else version (amd64) {
        options.verifier = &lfiv_verify_amd64;
    }
